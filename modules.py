...
class NVP(nn.Module):
    ...
    def forward(self, model_input, temporal_interp=False, params=None):
        ...
        # print("all_coords",model_input['all_coords'].size())   
        #all_coords torch.Size([4, 20736, 3])
        ...
        # print("spatial_embedding",spatial_embedding.size())    
        #spatial_embedding torch.Size([82944, 96])
